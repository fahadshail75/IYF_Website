...
const page = () => {
  ...
  return (
    <main className="max-w-[1600px] bg-white w-full px-5 md:px-10 2xl:px-0 mx-auto">
      <section className="gradient-bg py-20  px-5 md:px-10 lg:px-20 2xl:px-[100px] mb-10 xl:mb-20 2xl:mb-[160px] rounded-md">
        <h1 className="text-white font-bold text-3xl md:text-4xl xl:text-[40px] mb-5 md:mb-16">
          About Us
        </h1>
      ...
      <section className="flex flex-col md:flex-row md:items-center gap-5 md:gap-20 justify-between mb-14 xl:mb-20 2xl:mb-[160px]">
        <div className="md:w-1/2 border-l-2 md:border-l-[5px] border-[#22CA38] p-3 md:p-10">
          <h2 className="text-lg md:text-2xl font-semibold text-black mb-6">
            What is IYF and Why Should You Join It?{" "}
          </h2>
          <p className="text-sm md:text-xl text-[#202020]">
      ...
      <section className="flex flex-col-reverse md:flex-row md:items-center gap-5 md:gap-20 justify-between mb-14 xl:mb-20 2xl:mb-[160px]">
        <div className="md:w-1/2">
          <Image
        ...
        <div className=" md:w-1/2 ">
          <h2 className="text-lg md:text-2xl font-semibold text-black mb-5 md:mb-10">
            What IYF does ?{" "}
          </h2>
          ...
          <ul>
            {sectionData.map((_, index) => {
              return (
                <li
                  key={index}
                  className="flex md:items-center gap-2 mb-3 md:mb-5"
                >
                  ...
                  <p className="text-sm md:text-xl text-[#202020]">{_}</p>
                </li>
              );
            })}
          </ul>
      ...
      <section className="  mb-14 xl:mb-20 2xl:mb-[160px]">
        <div className="flex flex-col md:flex-row md:items-center gap-5 md:gap-20 justify-between">
          <div className="md:w-1/2">
            <h2 className="text-lg md:text-2xl font-semibold text-black mb-3 md:mb-6">
              IF YOU WANT TO...{" "}
            </h2>
            <ul className="list-disc pl-5 space-y-3 md:space-y-5">
              <li className="text-sm md:text-xl">
                Make your life and family meaningful
              </li>
              <li className="text-sm md:text-xl">
                Bring goodness in your society
              </li>
              <li className="text-sm md:text-xl">
                Help people live by Quran and justice
              </li>
              <li className="text-sm md:text-xl">
        ...
        <p className="text-lg md:text-2xl mt-5 md:mt-10 text-center">
      ...
      <section className="mb-10 xl:mb-20 2xl:mb-[160px]">
        <h2 className="font-bold text-2xl md:text-[32px] text-[#2F4858] text-center">
          Let’s Live a Purposeful Life
        </h2>
        <p className="my-6 md:my-10 xl:my-20 text-center text-lg md:text-2xl">
        ...
        <div className="space-y-6 md:space-y-10">
          <div className="p-5 md:p-10 border-t-[5px] border-[#22CA38] bg-white shadow rounded-md space-y-4 md:space-y-10">
            <h3 className="text-lg md:text-2xl font-semibold">
              Think About the Creator of This Universe
            </h3>

            <p className="text-sm md:text-xl font-normal text-[#000000]">
          ...
          <div className="p-5 md:p-10 border-t-[5px] border-[#22CA38] bg-white shadow rounded-md space-y-4 md:space-y-10">
            ...
            <ul className="list-disc pl-5 md:pl-10 space-y-3 md:space-y-4 text-sm md:text-xl font-normal text-[#000000]">
